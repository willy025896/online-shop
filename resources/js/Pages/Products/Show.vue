    ...
    <AppLayout :title="product.name">
        <div class="max-w-7xl mx-auto py-8 px-4 sm:px-6 lg:px-8">
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-8">
                ...
                <div>
                    ...
                    <div class="mt-6" v-if="product.stock > 0">
                        <p class="text-sm text-green-600 mb-3">In stock ({{ product.stock }} available)</p>
            ...
            <div v-if="relatedProducts.length" class="mt-16">
                <h2 class="text-xl font-bold text-gray-900 dark:text-gray-100 mb-6">Related Products</h2>
