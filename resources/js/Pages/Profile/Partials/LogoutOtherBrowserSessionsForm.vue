...
const lang = computed(() => page.props.lang.profile.session);
</script>
                    ...
                    <div class="ms-3">
                        ...
                        <div>
                            <div class="text-xs text-gray-500">
                                ...
                                <span v-if="session.is_current_device" class="text-green-500 font-semibold">{{ lang.this }}</span>
                                <span v-else>{{ lang.lastActive }} {{ session.last_active }}</span>
                            </div>
                        </div>
                    </div>
                </div>
