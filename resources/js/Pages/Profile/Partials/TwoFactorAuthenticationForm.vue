...
const lang = computed(() => page.props.lang.profile.twoFactor);
</script>
                ...
                <div v-if="qrCode">
                    ...
                    <div v-if="setupKey" class="mt-4 max-w-xl text-sm text-gray-600 dark:text-gray-400">
                        <p class="font-semibold">
                            {{ lang.setupKey }}: <span v-html="setupKey"></span>
                        </p>
                    </div>

                    <div v-if="confirming" class="mt-4">
                        <InputLabel for="code" :value="lang.enabling.code" />
