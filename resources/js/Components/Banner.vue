...
<template>
    <div>
        <div v-if="show && message" :class="{ 'bg-brand-500': style == 'success', 'bg-red-700': style == 'danger' }">
                ...
                <div class="flex items-center justify-between flex-wrap">
                    ...
                    <div class="shrink-0 sm:ms-3">
                        <button
                            ...
                            :class="{ 'hover:bg-brand-700 focus:bg-brand-700': style == 'success', 'hover:bg-red-600 focus:bg-red-600': style == 'danger' }"
                            aria-label="Dismiss"
